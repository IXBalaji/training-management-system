      ...
      <div className="container mx-auto py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Mark attendance for completed training sessions
          </p>
        </div>
        ...
        {trainings.length > 0 ? (
          <div className="space-y-6">
            {trainings.map((training) => {
              ...
              const enrollmentsWithAttendance = training.enrollments.map(
                (enrollment) => ({
                  ...enrollment,
                  attendance: training.attendance.filter(
                    (att) => att.userId === enrollment.userId,
                  ),
                }),
              );
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4 text-sm text-gray-600">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>
                            {training.enrollments.length} enrolled participants
                          </span>
                        </div>
                        <div className="flex items-center space-x-1">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Attendance tracking will be available after training sessions are
              completed
            </p>
          </div>
        )}
